...
export const authLogin = async (email, password) => {
  ...
  const baseURL = "https://34.227.53.65:8080/api/auth/login";
...
export const authGetCurrentUserInfo = async () => {
  try {
    const response = await axios.get("https://34.227.53.65:8080/api/auth", {
      headers: {
...
export const authRegister = async (email, password, username) => {
  ...
  const baseURL = "https://34.227.53.65:8080/api/auth/register";
